...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 16, 2024 at 11:24 AM
...
(1, 'Admin Phong', 'admin@gmail.com', '$2y$10$wHqjnF1KZkiephAY77gXfebuXJrGh/MT5UkUy6UZAAX8sLb.Gxe0W', '0123456789', NULL, 'K12DHPM 2022', '1185 Hoàng Văn Thụ Phường 9 Quận Phú Nhuận', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `articles` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `a_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `a_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `a_avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `attributes` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `atb_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `atb_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `atb_type_id` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `attributes_atb_name_unique` (`atb_name`),
  KEY `attributes_atb_type_id_index` (`atb_type_id`)
...
(1, '500 gram', '500-gram', 1, '2024-01-10 16:45:10', '2024-01-10 16:45:10'),
(2, '1 Kg', '1-kg', 1, '2024-01-08 16:45:10', '2024-01-08 16:45:10'),
(3, '2 Kg', '2-kg', 1, '2024-01-08 16:45:10', '2024-01-08 16:45:10'),
(4, '250 gram', '250-gram', 1, '2024-01-08 16:45:10', '2024-01-08 16:45:10'),
(5, '300 gram', '300-gram', 1, '2024-01-09 10:53:11', '2024-01-09 16:45:10'),
(6, 'Gói', 'goi', 2, '2024-01-09 16:45:10', '2024-01-09 16:45:10'),
(7, 'Hộp', 'hop', 2, '2024-01-09 16:45:10', '2024-01-09 16:45:10'),
(8, 'Thùng', 'thung', 2, '2024-01-09 16:45:10', '2024-01-09 16:45:10');
...
CREATE TABLE IF NOT EXISTS `categories` (
  ...
  `c_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `c_avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `c_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `c_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Rau củ quả', 0, 'rau-cu-qua', '2020-11-20__raucuqua.png', NULL, NULL, 1, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(2, 'Củ - Quả Hữu Cơ', 1, 'cu-qua-huu-co', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(3, 'Nấm - Rau mầm', 1, 'nam-rau-mam', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(4, 'Rau gia vị', 1, 'rau-gia-vi', NULL, NULL, NULL, 0, 1, '2024-01-03 14:00:00', '2024-01-03 14:00:31'),
(5, 'Rau hữu cơ', 1, 'rau-huu-co', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(6, 'Trái Cây Hữu Cơ', 0, 'trai-cay-huu-co', '2020-11-20__traicayhuco.png', NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(7, 'Trái cây khô', 6, 'trai-cay-kho', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(8, 'Trái cây nhập khẩu', 6, 'trai-cay-nhap-khau', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(9, 'Trái cây Việt', 6, 'trai-cay-viet', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(10, 'Đồ uống hữu cơ', 0, 'do-uong-huu-co', '2020-11-20__douong.png', NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(11, 'Kem hữu cơ', 10, 'kem-huu-co', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(12, 'Cà phê & Trà hữu cơ', 10, 'ca-phe-tra-huu-co', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(13, 'Mật ong và Detox', 10, 'mat-ong-va-detox', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(14, 'Nước khoáng - Đồ uống có cồn', 10, 'nuoc-khoang-do-uong-co-con', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(15, 'Nước trái cây hữu cơ', 10, 'nuoc-trai-cay-huu-co', NULL, NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(16, 'Thịt - Trứng', 0, 'thit-trung', '2020-11-20__thit.png', NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(17, 'Thủy - Hải sản', 0, 'thuy-hai-san', '2020-11-20__ca.png', NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26'),
(18, 'Đồ chế biến sẵn', 0, 'do-che-bien-san', '2020-11-20__wool.png', NULL, NULL, 0, 1, '2024-01-03 16:45:26', '2024-01-03 16:45:26');
...
CREATE TABLE IF NOT EXISTS `comments` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `cmt_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cmt_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, NULL, NULL, 'Sản phẩm rất tuyệt vời', 0, 11, 0, 2, 0, 0, '2024-01-13 16:45:44', '2024-01-13 16:45:44'),
(2, NULL, NULL, '@Hao: cám ơn shop', 1, 11, 0, 2, 0, 0, '2024-01-11 16:45:44', '2024-01-11 16:45:44'),
(5, NULL, NULL, 'sản phẩm này còn hàng không ?', 0, 10, 0, 35, 0, 0, '2024-01-03 15:17:59', '2024-01-03 16:45:26'),
(6, NULL, NULL, '@Thu Binh\r\n: còn ạ', 5, 10, 0, 35, 0, 0, '2024-01-10 15:18:28', NULL),
(7, NULL, NULL, 'Sản phẩm này rất tốt', 0, 14, 0, 41, 0, 0, '2024-01-03 08:53:44', '2024-01-03 16:45:26');
...
CREATE TABLE IF NOT EXISTS `contacts` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `c_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `events` (
  ...
  `e_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `e_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `e_detail_1` tinyint NOT NULL DEFAULT '0',
  `e_detail_2` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(1, 'sale 1', '2020-11-20__cua-hang-bach-hoa-xanh-tai-quang-son-ninh-son-2-1211x1713.jpg', '/', 1, 0, 0, 0, 0, 0, '2024-01-05 16:46:09', '2024-01-05 16:46:09'),
(2, 'sale 2', '2020-11-20__smart-food-banner.jpg', '/', 0, 1, 0, 0, 0, 0, '2024-01-05 16:46:09', '2024-01-05 16:46:09'),
(3, 'sale 3', '2020-11-20__11e93518327abdd246ba92c0d900162d.jpg', '/', 0, 0, 1, 0, 0, 0, '2024-01-05 16:46:09', '2024-01-05 16:46:09'),
(4, 'sale 4', '2020-11-21__cong-thuc-banner.jpg', '/', 0, 0, 0, 0, 1, 0, '2024-01-05 04:02:56', '2024-01-05 04:02:56'),
(5, 'sale 5', '2020-11-21__follow-nhan-uu-dai.jpg', '/', 0, 0, 0, 0, 0, 1, '2024-01-05 04:02:48', '2024-01-05 04:02:48');
...
CREATE TABLE IF NOT EXISTS `keywords` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `k_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `k_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `k_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Thực phẩm sạch', 'thuc-pham-sach', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(2, 'Rau quả hữu cơ', 'rau-qua-huu-co', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(3, 'Thực phẩm sạch vietgap', 'thuc-pham-sach-vietgap', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(4, 'Thực phẩm vietfoods', 'thuc-pham-vietfoods', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(5, 'Organicfood', 'organicfood', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(6, 'Rau quả thực phẩm sạch chuẩn VietGrap', 'rau-qua-thuc-pham-sach-chuan-vietgrap', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(7, 'Nông sản sạch', 'nong-san-sach', NULL, 0, '2024-01-06 16:46:28', '2024-01-06 16:46:28'),
(8, 'Mì Ly Cao Cấp', 'mi-ly-cao-cap', 'mì nhập khẩu', 0, '2024-01-06 15:00:25', '2024-01-06 16:46:28'),
(9, 'Mì chiên không dầu', 'mi-chien-khong-dau', 'mì nhập khẩu', 0, '2024-01-06 08:49:17', '2024-01-06 16:46:28');
...
CREATE TABLE IF NOT EXISTS `menus` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `mn_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mn_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mn_avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mn_banner` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mn_description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Tin tức mới', 'tin-tuc-moi', NULL, NULL, NULL, 0, 1, '2024-01-07 16:46:44', '2024-01-07 16:46:44'),
(2, 'Sự Kiện', 'su-kien', NULL, NULL, NULL, 0, 1, '2024-01-07 16:46:44', '2024-01-07 16:46:44'),
(3, 'Tin nổi bậc', 'tin-noi-bac', NULL, NULL, NULL, 0, 1, '2024-01-07 15:06:11', '2024-01-07 16:46:44'),
(4, 'Tin Xem Nhiều', 'tin-xem-nhieu', NULL, NULL, NULL, 0, 1, '2024-01-07 08:54:36', '2024-01-07 16:46:44');
...
CREATE TABLE IF NOT EXISTS `producer` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `pdr_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pdr_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pdr_email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pdr_phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `producer_pdr_slug_unique` (`pdr_slug`),
  UNIQUE KEY `producer_pdr_email_unique` (`pdr_email`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Nông sản nhật bản', 'nong-san-nhat-ban', 'nongsannhat@gmail.com', '19001907', '2024-01-10 16:47:15', '2024-01-10 16:47:15'),
(2, 'Hợ tác xã nông sản sạch', 'ho-tac-xa-nong-san-sach', 'hoptacnongsansach@gmail.com', '18008989', '2024-01-10 08:00:00', '2024-01-10 08:00:00'),
(3, 'Everyday Organic', 'everyday-organic', 'everydayorganic@gmail.com', '028 38 753 443', '2024-01-10 16:47:15', '2024-01-10 16:47:15'),
(4, 'Organicfood.vn', 'organicfoodvn', 'organicfood@gmail.com', '0928817228', '2024-01-10 16:47:15', '2024-01-10 16:47:15'),
(5, 'Thực phẩm sạch VietGrap', 'thuc-pham-sach-vietgrap', 'vietgap@fsi.org.vn', '02436341933', '2024-01-10 16:47:15', '2024-01-10 16:47:15'),
(6, 'Thực phẩm sạch vietfoods', 'thuc-pham-sach-vietfoods', 'vietfoods@gmail.com', '0243201075', '2024-01-10 16:47:15', '2024-01-10 16:47:15'),
(7, 'Acicook Mi hảo Hảo', 'acicook-mi-hao-hao', 'haohao@gmail.com', '03764641313', '2024-01-10 14:57:27', '2024-01-10 14:59:50'),
(8, 'Omachi', 'omachi', 'congtyomachi@gmail.com', '0333333333', '2024-01-10 08:48:57', '2024-01-10 08:50:00');
...
CREATE TABLE IF NOT EXISTS `products` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `pro_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pro_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pro_avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `product_images` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `pi_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pi_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(3, 37, 11, 2, 0, 'Sản phẩm rất tốt', '2024-01-15 14:53:54', '2024-01-15 14:53:54'),
(4, 38, 12, 5, 0, 'Sản phẩm rất tuyệt', '2024-01-15 14:53:54', '2024-01-15 14:53:54'),
(5, 39, 9, 3, 0, 'sản phẩm tốt nhất tôi từng mua!', '2024-01-15 14:53:54', '2024-01-15 14:53:54'),
(6, 36, 7, 5, 0, 'giá cả rất phải chăng!', '2024-01-15 14:53:54', '2024-01-15 14:53:54'),
(7, 35, 7, 4, 0, 'giao hàng rất nhanh, rất tốt !', '2024-01-15 14:53:54', '2024-01-15 14:53:54'),
(8, 41, 14, 5, 0, 'rất tốt đánh giá 5*', '2024-01-15 08:53:56', '2024-01-15 08:53:56');
...
CREATE TABLE IF NOT EXISTS `slides` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `sd_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sd_link` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sd_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'slide 1', '/', '2020-11-20__giai-phap-mo-cua-hang-thuc-pham-sach.jpg', 1, 1, 1, '2024-01-10 16:48:00', '2024-01-10 14:33:19'),
(2, 'slide 2', '/', '2020-11-20__vi-sao-mo-cua-hang-kinh-doanh-thuc-pham-sach-chua-hieu-qua-2-min.jpg', 1, 1, 0, '2024-01-10 16:48:00', '2024-01-10 16:48:00'),
(3, 'slide 5', '/', '2020-11-20__organic-food.jpg', 1, 1, 0, '2024-01-10 14:43:29', '2024-01-10 14:43:29');
...
CREATE TABLE IF NOT EXISTS `statics` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `s_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `s_type` tinyint NOT NULL DEFAULT '0',
  `s_md5` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `tst_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tst_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tst_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tst_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tst_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tst_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(10, 4, 140000, 'Phong', '69VJPuVSg6IFyKK', 'truongngoctanhieu2018@gmail.com', '0932023992', 'dsadsad', 'dadsd', 1, 1, '2024-01-10 12:31:52', '2024-01-10 16:47:15'),
(11, 4, 98000, 'Binh hh', 'w4tNV2D0Gj8kGqb', 'truongngoctanhieu2018@gmail.com', '0932023992', 'dsadsad', 'dasdasdas', 1, 1, '2024-01-10 12:34:07', '2024-01-10 12:40:00'),
(12, 34, 158000, 'Thi Hao', 'gID8cBMzfnh4Osi', 'thihao@gmail.com', '037575713213', '123 Long an', NULL, 1, 1, '2024-01-10 14:01:39', '2024-01-10 16:47:15'),
(13, 37, 64000, 'Hanh', 'MZxPjKlQLPmtaEW', 'honghanh@gmail.com', '9437284632', '3213', '321', 1, 1, '2024-01-10 14:51:43', '2024-01-10 16:48:00'),
(14, 40, 75000, 'Huong', 'i835f9laIpEY4jf', 'thihuong@gmail.com', '0354543135', '123 Gò Vấp', NULL, 1, 1, '2024-01-10 08:38:21', '2024-01-10 16:48:00');
...
CREATE TABLE IF NOT EXISTS `types` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `types_t_name_unique` (`t_name`)
...
(1, 'Khối lượng', 'khoi-luong', '2024-01-05 16:48:39', '2024-01-05 16:48:39'),
(2, 'Đơn vị', 'don-vi', '2024-01-05 16:48:39', '2024-01-05 16:48:39');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `facebook_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(34, 'Hao', 'thihao@gmail.com', NULL, '$2y$10$aA0To1xYapIqk4.bmSsAAe9p9n4iGAXtYnm6WAnQYKf2NkBSfNRKW', '037575713213', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2024-01-11 14:00:35', '2024-01-11 16:45:44'),
(36, 'Hồng Hạnh', 'honghanh@gmail.com', NULL, '$2y$10$MA1dE0zHKmBh/559L4WQDOpiRabbG7.sLvxwSjAge2bWfIsjEIusi', '0375754147', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2024-01-11 14:34:57', '2024-01-11 16:45:44'),
(37, 'Thu Bình', 'thubinh@gmail.com', NULL, '$2y$10$wHqjnF1KZkiephAY77gXfebuXJrGh/MT5UkUy6UZAAX8sLb.Gxe0W', '9437284632', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2024-01-11 14:35:40', '2024-01-11 16:45:44'),
(38, 'BBB', 'bbb@gmail.com', NULL, '$2y$10$wHqjnF1KZkiephAY77gXfebuXJrGh/MT5UkUy6UZAAX8sLb.Gxe0W', '0364543134', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2024-01-11 14:35:40', '2024-01-11 16:45:44'),
(39, 'Minh Mạnh', 'minhmanh@gmail.com', NULL, '$2y$10$wHqjnF1KZkiephAY77gXfebuXJrGh/MT5UkUy6UZAAX8sLb.Gxe0W', '03765323323', NULL, 0, NULL, NULL, NULL, NULL, NULL, '2024-01-11 14:35:40', '2024-01-11 16:45:44');
COMMIT;
